...
The Extension reads limited content and interface elements on the supported Blackboard Ultra deployment, such as course titles, section numbers, navigation items, and page structure. This processing is necessary to create course banners, improve the course grid, build the side navigation, apply reading themes, and provide keyboard navigation.
...
The Extension provides optional user-defined external links as well as a link to GitHub. These websites operate independently and are governed by their own privacy policies. The Extension does not send Blackboard page content to these websites.
